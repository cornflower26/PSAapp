...
static std::vector<Plaintext> rnn_ih, rnn_hh, fc_weight;
static Plaintext fc_bias;

static int num_inf, num_ref_correct, num_fhe_correct;
...
*/
static Ciphertext<DCRTPoly> rnn_layer(const Ciphertext<DCRTPoly> &input, const Ciphertext<DCRTPoly> &hidden, const CryptoContext<DCRTPoly> &cc, const KeyPair<DCRTPoly> keyPair) {
...
*/
static Ciphertext<DCRTPoly> fc_layer(const Ciphertext<DCRTPoly> &input, const CryptoContext<DCRTPoly> &cc, const KeyPair<DCRTPoly> keyPair) {
...
static float activation(float t) {
